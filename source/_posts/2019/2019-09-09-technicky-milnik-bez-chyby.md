...
### Z nevýhody výhodu
Nejprve jsme se pokoušeli chyby opravovat ručně, což bylo stejně úmorné, jako deprimující. Stejné chyby se totiž vracely z naprosto nečekaných důvodů a naše opravy se tak zdály být bojem s větrnými mlýny.
...
Během toho roka a půl jsme sepsali 313 hlubinných testů, které běží téměř tři minuty a provedou celkem 11516 kontrol.
...
- všechny externí odkazy (na [altar.cz](https://altar.cz), [Vukogvazdskou družinu](https://www.vukogvazd.cz/), [nemoci na Wikipedii](https://cs.wikipedia.org/wiki/Cholera) jsou kontrolované a platné a to prosím včetně #kotev odkazujících na konkrétní sekci
...
- Hraničář nemá prolinkované nástiny svých schopností s jejich detailním popisem (původní autoři chtěli udržet hráče v co největší nevědomosti, aby si užil krásu neznáma a objevování, což dost znesnadňuje orientaci v pravidlech).
...
Původní cíl, tedy mít pravidla na webu pro snazší orientaci, jsme úspěšně dotáhli do konce po [čtyřech letech převádění](/blog/2018/02/09/na_webu_jsou_vsechna_pravidla_a_co_ted) a dvou letech ladění, kdy končíme díky testům s čistým štítem a díky ukončené práci s čistou hlavou.
